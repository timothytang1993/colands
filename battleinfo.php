                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <table class='table table-striped table-bordered table-hover' ng-controller="battleInfo">
                                    <tr ng-repeat="battleDetail in battleDetail">
                                    <td>{{battleDetail.name}}</td>
                                    <td>{{battleDetail.content}}</td>
                                    </tr>
                                </table>
