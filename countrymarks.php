                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="dataTable_wrapper">
                                    <?php
                                    echo "<table class='table table-striped table-bordered table-hover' id='dataTables-country'>";
                                    //echo "<thead><tr><th>ID</th><th>First Name</th><th>Last Name</th><th>Email</th><th>Image</th><th>Action</th></tr></thead> <tbody>";
                                    echo "<thead><tr><th>國家名稱</th><th>國庫</th><th>格蘭斯大陸聲望</th></tr></thead> <tbody>";
                                    ...
                                    try {
                                        ...
                                        $stmt = $conn->prepare("SELECT * FROM country ORDER BY country_name");
                                        $stmt->execute();
                                        $stmt->setFetchMode(PDO::FETCH_ASSOC);
                                        
                                        foreach ($stmt->fetchAll() as $countryInfo) {
                                    ?>

                                            <tr>
                                                <td style='width:150px;border:1px solid black;'>
                                                    <?PHP echo htmlspecialchars($countryInfo["country_name"]) ?>
                                                </td>
                                                
                                                <td style='width:150px;border:1px solid black;'>
                                                    <?PHP echo htmlspecialchars($countryInfo["country_treasury"]) ?>
                                                </td>

                                                <td style='width:150px;border:1px solid black;'>
                                                    <?PHP echo htmlspecialchars($countryInfo["country_privilege"]) ?>
                                                </td>
                                            </tr>
