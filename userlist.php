                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="dataTable_wrapper">
                                    <?php
                                    echo "<table class='table table-striped table-bordered table-hover' id='dataTables-userList'>";
                                    //echo "<thead><tr><th>ID</th><th>First Name</th><th>Last Name</th><th>Email</th><th>Image</th><th>Action</th></tr></thead> <tbody>";
                                    echo "<thead><tr><th>玩家編號</th><th>玩家名稱</th><th>所屬國家</th></tr></thead> <tbody>";
                                    ...
                                    try {
                                        ...
                                        foreach ($stmt->fetchAll() as $userInfo) {
                                    ?>
                                            ...
                                            <tr>
                                                ...
                                                <td style='width:150px;border:1px solid black;'>
                                                    <?PHP echo htmlspecialchars($userInfo["user_name"]) ?>
                                                </td>

                                                <td style='width:150px;border:1px solid black;'>
                                                    <?PHP echo htmlspecialchars($userInfo["user_country_name"]) ?>
                                                </td>
                                            </tr>
