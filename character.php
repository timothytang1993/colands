                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <table class='table table-striped table-bordered table-hover' ng-controller="characterInfo">
                                    <tr>
                                    <th>人物名稱</th>
                                    <th>簡介</th>
                                    </tr>
                                    <tr ng-repeat="characterDetail in characterDetail">
                                    <td>{{characterDetail.name}}<br>
                                    <img ng-src="{{characterDetail.image}}"/>
                                        
                                    </td>
                                    <td>{{characterDetail.height}}<br>
                                        {{characterDetail.nationality}}<br>
                                        {{characterDetail.content}}<br>
                                        {{characterDetail.claim}}<br>
                                    </td>
                                    </tr>
                                </table>
